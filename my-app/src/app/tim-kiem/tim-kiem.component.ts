...
@Component({
    ...
    <div class="container search-results-page">
      <div class="search-header">
        ...
        <div class="search-stats">
          ...
          <span *ngIf="!loading && totalResults > 0">{{ totalResults }} kết quả</span>
          <span *ngIf="!loading && totalResults === 0">Không tìm thấy kết quả nào</span>
        </div>
      </div>
      
      <!-- Hiển thị công thức -->
      <div class="result-section" *ngIf="searchResults.recipes && searchResults.recipes.length > 0">
        <h2>Công thức</h2>
        <div class="products-grid-large">
          <div class="product-card product-card-large" *ngFor="let recipe of searchResults.recipes">
            <a [routerLink]="['/cong-thuc', recipe._id]">
              ...
              <div class="product-content">
                ...
                <div class="product-actions">
                  <div class="button-xemchitiet">XEM CHI TIẾT</div>
                </div>
              </div>
            </a>
          </div>
      ...
      <div class="result-section" *ngIf="searchResults.products && searchResults.products.length > 0">
        <h2>Nguyên liệu</h2>
        <div class="products-grid-large">
          <div class="product-card product-card-large" *ngFor="let product of searchResults.products">
            <a [routerLink]="['/chi-tiet-san-pham', product._id]">
              ...
              <div class="product-content">
                ...
                <div class="product-details">
                  <div class="price-container" *ngIf="product.pricePerPortion && product.pricePerPortion['2']">
                    <div class="price-tag">{{ product.pricePerPortion['2'] | number }} đ</div>
      ...
      <!-- Hiển thị blog -->
      <div class="result-section" *ngIf="searchResults.blogs && searchResults.blogs.length > 0">
        <h2>Blog</h2>
        <div class="blog-grid">
  ...
  styles: [`
    ...
    @media (max-width: 576px) {
      .products-grid, .products-grid-large, .blog-grid {
